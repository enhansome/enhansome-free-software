...
* [Nuclear Music Player](https://nuclear.js.org/) - Streaming music player that finds music from free sources automatically. ([GNU AGPLv3](https://github.com/nukeop/nuclear/blob/master/LICENSE) ⭐ 18,313 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-16)
* [LMMS](https://lmms.io/) - Complete digital audio workstation. ([GNU GPLv2+](https://github.com/LMMS/lmms/blob/master/LICENSE.txt) ⭐ 10,277 | 🐛 1,448 | 🌐 C++ | 📅 2026-08-21)
...
* [asciinema](https://asciinema.org/) - Terminal session recorder. ([GNU GPLv3](https://github.com/asciinema/asciinema/blob/develop/LICENSE) ⭐ 17,709 | 🐛 8 | 🌐 Rust | 📅 2026-08-14)
* [ranger](https://ranger.github.io/) - Minimal, lightweight, and aesthetically pleasing file explorer for GNU/Linux. It runs in the terminal window, so it fits in well with window managers such as i3. vi key bindings allow for quick operations to be performed, including rename and delete. ([GNU GPLv3](https://github.com/ranger/ranger/blob/master/README.md) ⭐ 17,361 | 🐛 899 | 🌐 Python | 📅 2026-08-15)
* [GNU stow](https://www.gnu.org/software/stow/) - GNU Stow is a symlink farm manager which takes distinct packages of software and/or data located in separate directories on the filesystem, and makes them appear to be installed in the same place. ([GNU GPLv3](https://github.com/ranger/ranger/blob/master/README.md) ⭐ 17,361 | 🐛 899 | 🌐 Python | 📅 2026-08-15)
* [Clipboard](https://github.com/Slackadays/Clipboard) ⭐ 5,879 | 🐛 26 | 🌐 C++ | 📅 2026-05-06 - Cut, copy, and paste anything, anywhere, all from the command line. ([GNU GPLv3](https://github.com/Slackadays/Clipboard/blob/main/LICENSE) ⭐ 5,879 | 🐛 26 | 🌐 C++ | 📅 2026-05-06)
...
* [Jitsi Meet](https://jitsi.org/jitsi-meet/) - Secure video conferencing and desktop sharing using WebRTC. ([Apache License 2.0](https://github.com/jitsi/jitsi-meet/blob/master/LICENSE) ⭐ 29,791 | 🐛 149 | 🌐 TypeScript | 📅 2026-08-22)
* [Signal](https://signal.org/) - Private messaging and calling for desktop, Android, and iOS. ([GNU GPLv3](https://github.com/WhisperSystems/Signal-Android/blob/master/LICENSE) ⭐ 29,240 | 🐛 482 | 🌐 Kotlin | 📅 2026-08-21)
* [Mail-in-a-Box](https://mailinabox.email/) - Easy-to-deploy mail server package for cloud computers. ([CC0](https://github.com/mail-in-a-box/mailinabox/blob/master/LICENSE) ⭐ 15,393 | 🐛 613 | 🌐 Python | 📅 2026-08-21)
...
* [Tutanota](https://tutanota.com/) - Encrypted email at no cost with support for business accounts. ([GNU GPLv3](https://github.com/tutao/tutanota/blob/master/LICENSE.txt) ⭐ 7,866 | 🐛 983 | 🌐 TypeScript | 📅 2026-08-21)
* [ProtonMail](https://protonmail.com/) - Secure web-based email service. ([MIT](https://github.com/ProtonMail/WebClient/blob/public/license.md) ⭐ 5,559 | 🐛 146 | 🌐 TypeScript | 📅 2026-08-21)
...
* [Filestash](http://www.filestash.app) - A Dropbox-like web client where users can bring their own backend (FTP, SFTP, Webdav, S3, Minio, ...). ([GNU AGPLv3](https://github.com/mickael-kerjean/filestash/blob/master/LICENSE) ⭐ 14,533 | 🐛 122 | 🌐 Go | 📅 2026-08-21)
* [WinSCP](https://github.com/winscp/winscp) ⭐ 3,785 | 🐛 1 | 🌐 C | 📅 2026-08-22 - SFTP and FTP client for Windows ([GNU GPLv3](https://github.com/winscp/winscp/blob/master/license.txt) ⭐ 3,785 | 🐛 1 | 🌐 C | 📅 2026-08-22)
...
* [Pinta](https://pinta-project.com/) - Gtk# clone of Paint.NET. ([MIT](https://github.com/PintaProject/Pinta/blob/master/license-mit.txt) ⭐ 3,891 | 🐛 225 | 🌐 C# | 📅 2026-08-21)
* [ExifCleaner](https://exifcleaner.com/) - GUI app to remove exif metadata from images and videos with simple drag and drop. ([MIT](https://github.com/szTheory/exifcleaner/blob/master/LICENSE) ⭐ 2,632 | 🐛 33 | 🌐 Perl | 📅 2026-08-22)
...
* [IntelliJ IDEA Community Edition](https://github.com/JetBrains/intellij-community) ⭐ 20,477 | 🐛 156 | 🌐 Java | 📅 2026-08-22 - Java/Android IDE with the goal of maximizing developer productivity. ([Apache License 2.0](https://github.com/JetBrains/intellij-community/blob/master/LICENSE.txt) ⭐ 20,477 | 🐛 156 | 🌐 Java | 📅 2026-08-22)
...
* [Open Office](https://github.com/apache/openoffice) ⭐ 1,230 | 🐛 19 | 🌐 C++ | 📅 2026-08-22 - Provides a full featured office productivity suite based on open standards. ([Apache License 2.0](https://github.com/apache/openoffice/blob/trunk/LICENSE) ⭐ 1,230 | 🐛 19 | 🌐 C++ | 📅 2026-08-22)
...
* [Electrum](https://electrum.org) - Lightweight Bitcoin client that provides wallet recovery, decentralized servers, and offline storage. ([MIT](https://github.com/spesmilo/electrum/blob/master/LICENCE) ⭐ 8,569 | 🐛 1,249 | 🌐 Python | 📅 2026-08-21)
* [GNU Taler](https://taler.net) - Cash-like system for online payments. ([GNU GPL](https://taler.net/en/developers.html))

### Scientific Work

* [JabRef](https://www.jabref.org) - Manages references and attached PDFs using BibTeX/BibLaTeX. Includes support for LibreOffice. ([MIT](https://github.com/JabRef/jabref/blob/master/LICENSE.md) ⭐ 4,633 | 🐛 525 | 🌐 Java | 📅 2026-08-22)
...
* [OBS Studio](https://obsproject.com/) - Screen recorder and video streaming application for all platforms. ([GNU GPLv2](https://github.com/jp9000/obs-studio/blob/master/COPYING) ⭐ 75,323 | 🐛 1,161 | 🌐 C | 📅 2026-08-23)
* [ShareX](https://getsharex.com/) - Screen capture, file sharing and productivity tool. ([GNU GPLv3](https://github.com/ShareX/ShareX/blob/master/LICENSE.txt) ⭐ 39,246 | 🐛 662 | 🌐 C# | 📅 2026-08-22)
...
* [VS Code](https://github.com/microsoft/vscode) ⭐ 189,277 | 🐛 20,129 | 🌐 TypeScript | 📅 2026-08-23 - A source-code editor made by Microsoft ([MIT](https://github.com/microsoft/vscode/blob/main/LICENSE.txt) ⭐ 189,277 | 🐛 20,129 | 🌐 TypeScript | 📅 2026-08-23)
...
* [Espanso](https://github.com/federico-terzi/espanso) ⭐ 14,332 | 🐛 535 | 🌐 Rust | 📅 2026-08-23 - A cross-playform text expander ([GNU GPLv3](https://github.com/federico-terzi/espanso/blob/master/LICENSE) ⭐ 14,332 | 🐛 535 | 🌐 Rust | 📅 2026-08-23)
...
* [youtube-dl](https://rg3.github.io/youtube-dl/) - Feature-rich command line program to download videos from YouTube and other video sites. ([Unlicense](https://github.com/rg3/youtube-dl/blob/master/LICENSE) ⭐ 141,002 | 🐛 4,129 | 🌐 Python | 📅 2026-02-19)
* [NewPipe](https://newpipe.schabi.org/) - Lightweight YouTube frontend for Android. ([GNU GPLv3](https://github.com/TeamNewPipe/NewPipe/blob/master/LICENSE) ⭐ 39,453 | 🐛 1,451 | 🌐 Java | 📅 2026-08-22)
* [MPV](https://mpv.io/) - Customizable multimedia player with scripting support. ([GNU GPLv2](https://github.com/mpv-player/mpv/blob/master/LICENSE.GPL/) ⭐ 36,633 | 🐛 1,138 | 🌐 C | 📅 2026-08-22)
* [Kodi](https://kodi.tv/) - Home Theater software and entertainment hub. ([GNU GPLv2](https://github.com/xbmc/xbmc/blob/master/README.md) ⭐ 21,117 | 🐛 465 | 🌐 C++ | 📅 2026-08-23)
...
* [Ghost](https://ghost.org/) - Hackable platform for building and running online publications. ([MIT](https://github.com/TryGhost/Ghost/blob/master/LICENSE) ⭐ 55,039 | 🐛 130 | 🌐 JavaScript | 📅 2026-08-23)
* [Mastodon](https://joinmastodon.org/) - Decentralized social network server. ([GNU AGPLv3](https://github.com/tootsuite/mastodon/blob/master/LICENSE) ⭐ 50,246 | 🐛 4,491 | 🌐 Ruby | 📅 2026-08-23)
* [Gogs](https://gogs.io/) - Lightweight, cross-platform, self-hosted Git service. ([MIT](https://github.com/gogits/gogs/blob/master/LICENSE) ⭐ 47,758 | 🐛 1,008 | 🌐 Go | 📅 2026-08-22)
* [Etherpad](http://etherpad.org/) - Collaborative document editing in real-time. ([Apache License 2.0](https://github.com/ether/etherpad-lite/blob/develop/LICENSE) ⭐ 18,499 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-21)
* [DocuSeal](https://www.docuseal.co/) - A platform to fill and sign digital documents. ([GNU AGPLv3](https://github.com/docusealco/docuseal/blob/master/LICENSE) ⭐ 18,333 | 🐛 118 | 🌐 Ruby | 📅 2026-08-17)
* [Wallabag](https://wallabag.org/en) - Save and classify articles. Read them later. Freely. ([MIT](https://github.com/wallabag/wallabag/blob/master/COPYING.md) ⭐ 12,926 | 🐛 760 | 🌐 PHP | 📅 2026-08-21)
...
* [Healthchecks](https://healthchecks.io/) - Cron job monitoring service. ([BSD 3-clause](https://github.com/healthchecks/healthchecks/blob/master/LICENSE) ⭐ 10,278 | 🐛 53 | 🌐 Python | 📅 2026-08-21)
* [Weblate](https://weblate.org) - Translation management system with version control integration. ([GNU GPLv3](https://github.com/WeblateOrg/weblate/blob/master/COPYING) ⭐ 6,034 | 🐛 498 | 🌐 Python | 📅 2026-08-23)
...
* [Tolgee](https://tolgee.io) - Developer & translator friendly web-based localization platform. ([Apache License 2.0](https://github.com/tolgee/tolgee-platform/blob/main/LICENSE) ⭐ 4,080 | 🐛 196 | 🌐 TypeScript | 📅 2026-08-22)
* [Dnote](https://www.getdnote.com/) - A simple command line notebook with multi-device sync and web interface. ([GNU AGPLv3](https://github.com/dnote/dnote/blob/master/licenses/AGPLv3.txt) ⭐ 3,064 | 🐛 40 | 🌐 Go | 📅 2026-07-25)
* [Neocities](https://neocities.org/) - GeoCities for the modern world. ([BSD 2-clause](https://github.com/neocities/neocities/blob/master/LICENSE.txt) ⭐ 1,898 | 🐛 95 | 🌐 JavaScript | 📅 2026-08-18)
...
* [Awesome Self-Hosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 314,372 | 🐛 0 | 📅 2026-08-22 - List of FLOSS network services and web applications which can be hosted locally.
* [Awesome Sysadmin](https://github.com/n1trux/awesome-sysadmin) ⭐ 34,957 | 🐛 0 | 📅 2026-08-19 - List of free software sysadmin tools.
