...
* [Nuclear Music Player](https://nuclear.js.org/) - Streaming music player that finds music from free sources automatically. ([GNU AGPLv3](https://github.com/nukeop/nuclear/blob/master/LICENSE) ⭐ 18,409 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-07)
* [LMMS](https://lmms.io/) - Complete digital audio workstation. ([GNU GPLv2+](https://github.com/LMMS/lmms/blob/master/LICENSE.txt) ⭐ 10,342 | 🐛 1,455 | 🌐 C++ | 📅 2026-09-05)
* [mStream](http://mstream.io/) - Suite of software for syncing and streaming music across multiple devices. ([GNU GPLv3](https://github.com/IrosTheBeggar/mStream/blob/master/LICENSE) ⭐ 2,386 | 🐛 95 | 🌐 JavaScript | 📅 2026-09-08)
...
* [asciinema](https://asciinema.org/) - Terminal session recorder. ([GNU GPLv3](https://github.com/asciinema/asciinema/blob/develop/LICENSE) ⭐ 17,779 | 🐛 10 | 🌐 Rust | 📅 2026-08-14)
* [ranger](https://ranger.github.io/) - Minimal, lightweight, and aesthetically pleasing file explorer for GNU/Linux. It runs in the terminal window, so it fits in well with window managers such as i3. vi key bindings allow for quick operations to be performed, including rename and delete. ([GNU GPLv3](https://github.com/ranger/ranger/blob/master/README.md) ⭐ 17,393 | 🐛 897 | 🌐 Python | 📅 2026-08-31)
* [GNU stow](https://www.gnu.org/software/stow/) - GNU Stow is a symlink farm manager which takes distinct packages of software and/or data located in separate directories on the filesystem, and makes them appear to be installed in the same place. ([GNU GPLv3](https://github.com/ranger/ranger/blob/master/README.md) ⭐ 17,393 | 🐛 897 | 🌐 Python | 📅 2026-08-31)
* [Clipboard](https://github.com/Slackadays/Clipboard) ⭐ 5,897 | 🐛 26 | 🌐 C++ | 📅 2026-05-06 - Cut, copy, and paste anything, anywhere, all from the command line. ([GNU GPLv3](https://github.com/Slackadays/Clipboard/blob/main/LICENSE) ⭐ 5,897 | 🐛 26 | 🌐 C++ | 📅 2026-05-06)
* [Kit CLI](https://github.com/jozu-ai/kitops?tab=readme-ov-file) ⭐ 1,411 | 🐛 51 | 🌐 Go | 📅 2026-09-07 - Open source MLOps tool that allows you to create, manage, run, and deploy ModelKits using Kitfiles. From packaging new models to deploying existing ones, Kit CLI lets you streamline workflows effortlessly. ([Apache License 2.0](https://github.com/jozu-ai/kitops/blob/main/LICENSE) ⭐ 1,411 | 🐛 51 | 🌐 Go | 📅 2026-09-07)
...
* [Jitsi Meet](https://jitsi.org/jitsi-meet/) - Secure video conferencing and desktop sharing using WebRTC. ([Apache License 2.0](https://github.com/jitsi/jitsi-meet/blob/master/LICENSE) ⭐ 29,886 | 🐛 143 | 🌐 TypeScript | 📅 2026-09-07)
* [Signal](https://signal.org/) - Private messaging and calling for desktop, Android, and iOS. ([GNU GPLv3](https://github.com/WhisperSystems/Signal-Android/blob/master/LICENSE) ⭐ 29,309 | 🐛 499 | 🌐 Kotlin | 📅 2026-09-04)
* [Mail-in-a-Box](https://mailinabox.email/) - Easy-to-deploy mail server package for cloud computers. ([CC0](https://github.com/mail-in-a-box/mailinabox/blob/master/LICENSE) ⭐ 15,412 | 🐛 610 | 🌐 Python | 📅 2026-09-01)
...
* [Tutanota](https://tutanota.com/) - Encrypted email at no cost with support for business accounts. ([GNU GPLv3](https://github.com/tutao/tutanota/blob/master/LICENSE.txt) ⭐ 7,904 | 🐛 996 | 🌐 TypeScript | 📅 2026-09-07)
* [ProtonMail](https://protonmail.com/) - Secure web-based email service. ([MIT](https://github.com/ProtonMail/WebClient/blob/public/license.md) ⭐ 5,577 | 🐛 154 | 🌐 TypeScript | 📅 2026-09-07)
* [Tox](https://tox.chat/) - Encrypted and distributed messaging platform with voice, video, and screen sharing. ([GNU GPLv3](https://github.com/TokTok/c-toxcore/blob/master/COPYING) ⭐ 2,680 | 🐛 221 | 🌐 C | 📅 2026-09-07)
...
* [Filestash](http://www.filestash.app) - A Dropbox-like web client where users can bring their own backend (FTP, SFTP, Webdav, S3, Minio, ...). ([GNU AGPLv3](https://github.com/mickael-kerjean/filestash/blob/master/LICENSE) ⭐ 14,632 | 🐛 123 | 🌐 Go | 📅 2026-09-08)
* [WinSCP](https://github.com/winscp/winscp) ⭐ 3,823 | 🐛 1 | 🌐 C | 📅 2026-09-03 - SFTP and FTP client for Windows ([GNU GPLv3](https://github.com/winscp/winscp/blob/master/license.txt) ⭐ 3,823 | 🐛 1 | 🌐 C | 📅 2026-09-03)
...
* [Pinta](https://pinta-project.com/) - Gtk# clone of Paint.NET. ([MIT](https://github.com/PintaProject/Pinta/blob/master/license-mit.txt) ⭐ 4,021 | 🐛 227 | 🌐 C# | 📅 2026-09-07)
* [ExifCleaner](https://exifcleaner.com/) - GUI app to remove exif metadata from images and videos with simple drag and drop. ([MIT](https://github.com/szTheory/exifcleaner/blob/master/LICENSE) ⭐ 2,671 | 🐛 41 | 🌐 Perl | 📅 2026-09-07)
...
* [IntelliJ IDEA Community Edition](https://github.com/JetBrains/intellij-community) ⭐ 20,528 | 🐛 160 | 🌐 Java | 📅 2026-09-08 - Java/Android IDE with the goal of maximizing developer productivity. ([Apache License 2.0](https://github.com/JetBrains/intellij-community/blob/master/LICENSE.txt) ⭐ 20,528 | 🐛 160 | 🌐 Java | 📅 2026-09-08)
...
* [Open Office](https://github.com/apache/openoffice) ⭐ 1,237 | 🐛 18 | 🌐 C++ | 📅 2026-09-08 - Provides a full featured office productivity suite based on open standards. ([Apache License 2.0](https://github.com/apache/openoffice/blob/trunk/LICENSE) ⭐ 1,237 | 🐛 18 | 🌐 C++ | 📅 2026-09-08)
...
* [Electrum](https://electrum.org) - Lightweight Bitcoin client that provides wallet recovery, decentralized servers, and offline storage. ([MIT](https://github.com/spesmilo/electrum/blob/master/LICENCE) ⭐ 8,583 | 🐛 1,253 | 🌐 Python | 📅 2026-09-07)
* [GNU Taler](https://taler.net) - Cash-like system for online payments. ([GNU GPL](https://taler.net/en/developers.html))

### Scientific Work

* [JabRef](https://www.jabref.org) - Manages references and attached PDFs using BibTeX/BibLaTeX. Includes support for LibreOffice. ([MIT](https://github.com/JabRef/jabref/blob/master/LICENSE.md) ⭐ 4,702 | 🐛 516 | 🌐 Java | 📅 2026-09-08)
...
* [OBS Studio](https://obsproject.com/) - Screen recorder and video streaming application for all platforms. ([GNU GPLv2](https://github.com/jp9000/obs-studio/blob/master/COPYING) ⭐ 75,944 | 🐛 1,170 | 🌐 C | 📅 2026-09-05)
* [ShareX](https://getsharex.com/) - Screen capture, file sharing and productivity tool. ([GNU GPLv3](https://github.com/ShareX/ShareX/blob/master/LICENSE.txt) ⭐ 39,486 | 🐛 647 | 🌐 C# | 📅 2026-09-08)
...
* [VS Code](https://github.com/microsoft/vscode) ⭐ 191,467 | 🐛 20,681 | 🌐 TypeScript | 📅 2026-09-08 - A source-code editor made by Microsoft ([MIT](https://github.com/microsoft/vscode/blob/main/LICENSE.txt) ⭐ 191,467 | 🐛 20,681 | 🌐 TypeScript | 📅 2026-09-08)
...
* [Espanso](https://github.com/federico-terzi/espanso) ⭐ 14,446 | 🐛 537 | 🌐 Rust | 📅 2026-09-07 - A cross-playform text expander ([GNU GPLv3](https://github.com/federico-terzi/espanso/blob/master/LICENSE) ⭐ 14,446 | 🐛 537 | 🌐 Rust | 📅 2026-09-07)
...
* [youtube-dl](https://rg3.github.io/youtube-dl/) - Feature-rich command line program to download videos from YouTube and other video sites. ([Unlicense](https://github.com/rg3/youtube-dl/blob/master/LICENSE) ⭐ 141,156 | 🐛 4,125 | 🌐 Python | 📅 2026-02-19)
* [NewPipe](https://newpipe.schabi.org/) - Lightweight YouTube frontend for Android. ([GNU GPLv3](https://github.com/TeamNewPipe/NewPipe/blob/master/LICENSE) ⭐ 39,627 | 🐛 1,451 | 🌐 Java | 📅 2026-08-31)
* [MPV](https://mpv.io/) - Customizable multimedia player with scripting support. ([GNU GPLv2](https://github.com/mpv-player/mpv/blob/master/LICENSE.GPL/) ⭐ 36,894 | 🐛 1,144 | 🌐 C | 📅 2026-09-08)
* [Kodi](https://kodi.tv/) - Home Theater software and entertainment hub. ([GNU GPLv2](https://github.com/xbmc/xbmc/blob/master/README.md) ⭐ 21,192 | 🐛 473 | 🌐 C++ | 📅 2026-09-08)
...
* [Ghost](https://ghost.org/) - Hackable platform for building and running online publications. ([MIT](https://github.com/TryGhost/Ghost/blob/master/LICENSE) ⭐ 55,204 | 🐛 177 | 🌐 TypeScript | 📅 2026-09-08)
* [Mastodon](https://joinmastodon.org/) - Decentralized social network server. ([GNU AGPLv3](https://github.com/tootsuite/mastodon/blob/master/LICENSE) ⭐ 50,283 | 🐛 4,531 | 🌐 Ruby | 📅 2026-09-08)
* [Gogs](https://gogs.io/) - Lightweight, cross-platform, self-hosted Git service. ([MIT](https://github.com/gogits/gogs/blob/master/LICENSE) ⭐ 47,806 | 🐛 1,010 | 🌐 Go | 📅 2026-09-06)
* [Etherpad](http://etherpad.org/) - Collaborative document editing in real-time. ([Apache License 2.0](https://github.com/ether/etherpad-lite/blob/develop/LICENSE) ⭐ 18,538 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-07)
* [DocuSeal](https://www.docuseal.co/) - A platform to fill and sign digital documents. ([GNU AGPLv3](https://github.com/docusealco/docuseal/blob/master/LICENSE) ⭐ 18,467 | 🐛 120 | 🌐 Ruby | 📅 2026-09-07)
* [Wallabag](https://wallabag.org/en) - Save and classify articles. Read them later. Freely. ([MIT](https://github.com/wallabag/wallabag/blob/master/COPYING.md) ⭐ 12,957 | 🐛 762 | 🌐 PHP | 📅 2026-09-07)
...
* [Healthchecks](https://healthchecks.io/) - Cron job monitoring service. ([BSD 3-clause](https://github.com/healthchecks/healthchecks/blob/master/LICENSE) ⭐ 10,310 | 🐛 53 | 🌐 Python | 📅 2026-09-02)
* [Weblate](https://weblate.org) - Translation management system with version control integration. ([GNU GPLv3](https://github.com/WeblateOrg/weblate/blob/master/COPYING) ⭐ 6,059 | 🐛 504 | 🌐 Python | 📅 2026-09-07)
* [Lobsters](https://lobste.rs/) - Link aggregation and discussion with downvote explanations. ([BSD 3-clause](https://github.com/lobsters/lobsters/blob/master/LICENSE) ⭐ 4,825 | 🐛 262 | 🌐 Ruby | 📅 2026-09-04)
* [Tolgee](https://tolgee.io) - Developer & translator friendly web-based localization platform. ([Apache License 2.0](https://github.com/tolgee/tolgee-platform/blob/main/LICENSE) ⭐ 4,092 | 🐛 191 | 🌐 TypeScript | 📅 2026-09-08)
* [Dnote](https://www.getdnote.com/) - A simple command line notebook with multi-device sync and web interface. ([GNU AGPLv3](https://github.com/dnote/dnote/blob/master/licenses/AGPLv3.txt) ⭐ 3,079 | 🐛 40 | 🌐 Go | 📅 2026-07-25)
* [Neocities](https://neocities.org/) - GeoCities for the modern world. ([BSD 2-clause](https://github.com/neocities/neocities/blob/master/LICENSE.txt) ⭐ 1,907 | 🐛 95 | 🌐 JavaScript | 📅 2026-09-06)
...
* [Awesome Self-Hosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 317,813 | 🐛 0 | 📅 2026-09-06 - List of FLOSS network services and web applications which can be hosted locally.
* [Awesome Sysadmin](https://github.com/n1trux/awesome-sysadmin) ⭐ 35,102 | 🐛 0 | 📅 2026-09-02 - List of free software sysadmin tools.
